...
class BaselineNLPFlow(FlowSpec):
    ...
    def baseline(self):
        ...
        accuracy = accuracy_score(self.valdf['label'], self.valdf['preds'] )
        roc_auc = roc_auc_score(self.valdf['label'], self.valdf['preds'] )
    ...
    def end(self):
        ...
        FP = self.valdf[(self.valdf['preds'] == 1) & (self.valdf['label'] == 0)]
        ...
        FN = self.valdf[(self.valdf['preds'] == 0) & (self.valdf['label'] == 1)]
